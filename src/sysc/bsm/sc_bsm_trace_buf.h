#ifndef SRC_SYSC_BSM_SC_BSM_TRACE_BUF_H_
#define SRC_SYSC_BSM_SC_BSM_TRACE_BUF_H_
...
class bsm_trace_buf : sc_stage_callback_if {
 public:
...
#endif  // SRC_SYSC_BSM_SC_BSM_TRACE_BUF_H_
