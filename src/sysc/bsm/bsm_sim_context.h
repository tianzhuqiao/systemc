#ifndef SRC_SYSC_BSM_BSM_SIM_CONTEXT_H_
#define SRC_SYSC_BSM_BSM_SIM_CONTEXT_H_
...
enum {
    SC_OBJ_UNKNOWN, SC_OBJ_SIGNAL, SC_OBJ_CLOCK, SC_OBJ_INPUT, SC_OBJ_OUTPUT,
    SC_OBJ_INOUT, SC_OBJ_MODULE, SC_OBJ_XSC_PROP, SC_OBJ_XSC_ARRAY,
...
#endif  // SRC_SYSC_BSM_BSM_SIM_CONTEXT_H_
