...
bsm_trace_buf::trace(const tp&        object_,                                \
    ...
    traces.push_back(new buf_signed_ ## tp ## _trace(object_, width_));       \
}
...
bsm_trace_buf::trace(const unsigned tp& object_,                              \
    ...
    traces.push_back(new buf_unsigned_ ## tp ## _trace( object_, width_));    \
}
...
bsm_trace_buf::trace(const sc_dt::tp& object_,                                \
    ...
    traces.push_back(new buf_ ## tp ## _trace(object_, width_));              \
}
...
void bsm_trace_buf::stage_callback(const sc_stage & stage) {
...
bsm_trace_buf* sc_create_bsm_trace_buf(const char * name) {
    bsm_trace_buf *tf = new bsm_trace_buf(name);
    return tf;
}
